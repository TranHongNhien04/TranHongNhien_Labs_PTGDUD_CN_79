            ...
            <div className="col-span-3 row-span-3 grid grid-cols-3 grid-rows-3 gap-x-3 border-b p-4">
                ...
                <div className="col-span-1 row-span-2 bg-pink-100 rounded-md p-3">
                    <div className="flex justify-between">
                        <h3 className="text-sm font-bold">Turnover</h3>
                        <button>
                            <img src={Button1509} alt="" className="h-8 w-8" />
                        </button>
                    </div>
                    <div>$92,405</div>
                    <div>^5.39%</div>
                ...
                <div className="col-span-1 row-span-2 bg-blue-100 rounded-md p-3">
                    <div className="flex justify-between">
                        <h3 className="text-sm font-bold">Turnover</h3>
                        <button>
                            <img src={Button1529} alt="" className="h-8 w-8" />
                        </button>
                    </div>
                    <div>$92,405</div>
                    <div>^5.39%</div>
                ...
                <div className="col-span-1 row-span-2 bg-blue-100 rounded-md p-3">
                    <div className="flex justify-between">
                        <h3 className="text-sm font-bold">Turnover</h3>
                        <button>
                            <img src={Button1530} alt="" className="h-8 w-8" />
                        </button>
                    </div>
                    <div>$92,405</div>
                    <div>^5.39%</div>
